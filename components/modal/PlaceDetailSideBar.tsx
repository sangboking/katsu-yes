...
const PlaceDetailSideBar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-full md:w-[390px] bg-white shadow-lg z-[1000] flex flex-col overflow-y-auto overflow-x-hidden scrollbar-gutter-stable">
      <button
